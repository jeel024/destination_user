...
class ViewAllScreen extends StatefulWidget {
  ...
  ViewAllScreen({required this.name, this.catId, this.stateId, this.cityId, this.placesType, this.position});
...
class ViewAllScreenState extends State<ViewAllScreen> {
  ...
  void init() async {
    ...
    if (widget.placesType == placesTypeNearBy && widget.position!=null) {
      ...
      await placeService.fetchPlaceList(list: placeList, catId: widget.catId, stateId: widget.stateId,cityId: widget.cityId, isPopular: widget.placesType == placesTypePopular).then((value) {
