...
class PlacesRequestScreenState extends State<PlacesRequestScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(language.placesRequest),),
      ...
      child: Container(padding: EdgeInsets.all(10),decoration: BoxDecoration(color: primaryColor,borderRadius: BorderRadius.circular(8)),child: Text("Add Place", style: boldTextStyle(color: Colors.white)))),
