...
class HtmlWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Html(
      data: postContent!,onLinkTap: (url, attributes, element) {
      mLaunchUrl(url!, forceWebView: true);
      },
      ...
      style: {
        ...
        'figure': Style(color: color ?? textPrimaryColorGlobal, fontSize: FontSize(16), padding: HtmlPaddings.zero, margin: Margins.zero),
